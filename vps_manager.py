...
app = Flask(__name__)
# 
#TODO verty Important to change this
dburl = ""
...
def create_user():
    ...
    # sum expire_date with now
    expire_date = expire_date + int(jdatetime.datetime.now().timestamp())
...
def remove_user():
    ...
    conn = sqlite3.connect("100-user-x-ui.db")
    c = conn.cursor()
...
@app.route('/change_total_traffics')
